    ...
    <>
      ...
      <PageContainer>
        <div className="itemcontainer">
          ...
          <div className="item">
            <img src="/assets/image/unstruck.svg" alt="unstruck"></img>
            Get unstruck — ask a question
          </div>
          <div className="item">
            <img src="/assets/image/unlock.svg" alt="unlock"></img>
            Unlock new privileges like voting and commenting
          </div>
          <div className="blockitem">
            <img src="/assets/image/save.svg" alt="earn"></img>
            Save your favorite questions, answers, watch tags, and more
          </div>

          <div className="item">
            <img src="/assets/image/earn.svg" alt="earn"></img>Earn reputation
            and badges
          </div>
          <div className="item2">
